...
public:
    static ElectroMagn* create(PicParams& params,  InputData &input_data) {
        ElectroMagn* EMfields = NULL;
        if ( params.geometry == "1d3v" ) {
            EMfields = new ElectroMagn1D(params, input_data);
        }
        else if ( params.geometry == "2d3v" ) {
            EMfields = new ElectroMagn2D(params, input_data);
        }
        else if ( params.geometry == "3d3v" ) {
            EMfields = new ElectroMagn3D(params, input_data);
        }
        else {
