...
EF_Solver1D_GeneralThomas::EF_Solver1D_GeneralThomas(PicParams &params, int nx_sou_left)
    : Solver1D(params)
{
...
void EF_Solver1D_GeneralThomas::operator()( ElectroMagn* fields)
{
    ...
    solve_GeneralThomas(rho1D, phi1D);
    solve_Ex(phi1D, Ex1D);
}
