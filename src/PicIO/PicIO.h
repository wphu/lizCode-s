...
public:
    ...
    //virtual void calVDF( PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies){};

    // store Particles to restart
    virtual void storeP(PicParams& params, vector<Species*>& vecSpecies, int itime );

    // reload Particles to restart
    virtual void reloadP(PicParams& params, vector<Species*>& vecSpecies );

    // store Particles to restart
    virtual void endStoreP(PicParams& params, vector<Species*>& vecSpecies, int itime );
