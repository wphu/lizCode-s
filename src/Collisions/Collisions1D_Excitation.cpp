...
// Constructor
Collisions1D_Excitation::Collisions1D_Excitation(PicParams& params, vector<Species*>& vecSpecies,
    unsigned int n_col,
...
void Collisions1D_Excitation::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
