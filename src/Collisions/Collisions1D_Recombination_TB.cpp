...
// Constructor
Collisions1D_Recombination_TB::Collisions1D_Recombination_TB(PicParams& params, vector<Species*>& vecSpecies,
    unsigned int n_col,
...
void Collisions1D_Recombination_TB::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
