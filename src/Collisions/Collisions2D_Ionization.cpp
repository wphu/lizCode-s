...
// Constructor
Collisions2D_Ionization::Collisions2D_Ionization(PicParams& params, vector<Species*>& vecSpecies,
...
void Collisions2D_Ionization::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
