...
// Constructor
Collisions2D_Elastic::Collisions2D_Elastic(PicParams& params, vector<Species*>& vecSpecies,
...
void Collisions2D_Elastic::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
