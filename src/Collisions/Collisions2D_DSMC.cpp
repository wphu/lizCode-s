...
// Constructor
Collisions2D_DSMC::Collisions2D_DSMC(PicParams& params, vector<Species*>& vecSpecies,
...
void Collisions2D_DSMC::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
