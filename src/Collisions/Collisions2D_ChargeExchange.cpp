...
// Constructor
Collisions2D_ChargeExchange::Collisions2D_ChargeExchange(PicParams& params, vector<Species*>& vecSpecies,
                       unsigned int n_col,
...
void Collisions2D_ChargeExchange::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
