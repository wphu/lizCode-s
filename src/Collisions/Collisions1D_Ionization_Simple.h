...
public:
    ...
    Collisions1D_Ionization_Simple(PicParams&,std::vector<Species*>&,unsigned int,std::vector<unsigned int>,std::vector<unsigned int>,std::vector<unsigned int>,double,bool,int);
