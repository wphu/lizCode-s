...
// Constructor
Collisions1D_Ionization_Simple::Collisions1D_Ionization_Simple(PicParams& params, vector<Species*>& vecSpecies,
...
void Collisions1D_Ionization_Simple::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
