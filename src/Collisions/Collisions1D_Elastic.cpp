...
// Constructor
Collisions1D_Elastic::Collisions1D_Elastic(PicParams& params, vector<Species*>& vecSpecies,
...
void Collisions1D_Elastic::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
