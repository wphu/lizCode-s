...
// Constructor
Collisions2D_Coulomb::Collisions2D_Coulomb(PicParams& params, vector<Species*>& vecSpecies,
...
void Collisions2D_Coulomb::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
