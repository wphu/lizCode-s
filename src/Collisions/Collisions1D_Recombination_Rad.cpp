...
// Constructor
Collisions1D_Recombination_Rad::Collisions1D_Recombination_Rad(PicParams& params, vector<Species*>& vecSpecies,
    unsigned int n_col,
...
Collisions1D_Recombination_Rad::~Collisions1D_Recombination_Rad()
{
...
void Collisions1D_Recombination_Rad::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
...
void Collisions1D_Recombination_Rad::calculate_scatter_velocity( double v_magnitude, double mass1, double mass2,
...
double Collisions1D_Recombination_Rad::cross_section(double ke)
{
