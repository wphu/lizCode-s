...
// Constructor
Collisions1D_Coulomb::Collisions1D_Coulomb(PicParams& params, vector<Species*>& vecSpecies,
                       unsigned int n_col,
...
void Collisions1D_Coulomb::collide(PicParams& params, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
    ...
    for (unsigned int ibin=0 ; ibin<nbins ; ibin++)
    {
        ...
        for(int i = 0; i < n_collisionPairs; i++)
        {
          ...
          for (unsigned int j = 0; j < n_indexes[i]; j++)
          {
              ...
              s = A12 * timesteps_collision * timestep * collision_zoom_factor / g_3;
              if(isOdd[j])
              {
...
void Collisions1D_Coulomb::collide_relativistic(PicParams& params, vector<Species*>& vecSpecies, int itime)
{
