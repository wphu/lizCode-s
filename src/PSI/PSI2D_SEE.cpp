...
// Constructor
PSI2D_SEE::PSI2D_SEE(PicParams& params):
PSI2D(params)
{
...
void PSI2D_SEE::performPSI(PicParams& params, Grid* grid, vector<Species*>& vecSpecies, ElectroMagn* fields, Diagnostic* diag, int itime)
{
